...
# For building rtorent
LIBCURL_NAME="curl-7.45.0"
LIBCURL_URL="http://curl.haxx.se/download/$LIBCURL_NAME.tar.gz"
SIGCPP20_NAME="libsigc++-2.6.2"
SIGCPP20_URL="http://ftp.gnome.org/pub/GNOME/sources/libsigc++/2.6/$SIGCPP20_NAME.tar.gz"
...
NGINX_NAME="nginx-1.9.7"
NGINX_URL="http://nginx.org/download/$NGINX_NAME.tar.gz"

LIGHTTPD_NAME="lighttpd-1.4.37"
